file_path <- "/user/HS402/hm01626/Downloads/train_data.csv"
your_data_frame <- read.csv(file_path)
...
your_data_frame <- your_data_frame[, c("ID_Patient_Care_Situation", "Diagnosed_Condition", "Patient_ID")]
